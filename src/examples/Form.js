...
const Form = () => {
  ...
  return (
    <section className="bg-blue-900 h-screen w-screen flex justify-center items-center overflow-auto">
      <div className="shadow-lg p-10 rounded-md max-w-3xl w-full justify-between bg-white">
        <form onSubmit={submit} className="flex flex-wrap lg:gap-x-10 gap-y-3">
          ...
          <div className="flex justify-between items-center w-full">
            ...
            <button
              className="px-8 py-2 bg-indigo-500 rounded-md font-semibold text-white text-lg disabled:bg-gray-500"
              type="submit"
              disabled={!state.term}
            >
              Submit
